...
class JurnalUmum extends CI_Controller
{
	...
	{
		$this->data['page_title'] = "List Jurnal Umum";
		$this->data['page_content'] = "FinanceAccounting/JurnalUmum/index";
		$this->data['akun_induk'] = $this->db->query('SELECT
													*
												FROM
													tmst_akun_induk');
		$this->data['script_page'] =  '<script src="' . base_url() . 'assets/financeaccounting-script/JurnalUmum/index.js?v=' . time() . '"></script>';
	...
	public function print($sysid)
	{
		...
		$html = $this->load->view('Print/report_jurnal_umum', $data, true);
