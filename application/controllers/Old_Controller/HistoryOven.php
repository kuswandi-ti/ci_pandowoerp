...
class HistoryOven extends CI_Controller
{
    ...
    {
        $this->data['page_title'] = "History Material Masuk Oven";
        $this->data['page_content'] = "History/material_masuk_oven";
        $this->data['script_page'] =  '<script src="' . base_url() . 'assets/StockInOven-script/history.js"></script>';
