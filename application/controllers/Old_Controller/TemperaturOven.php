...
class TemperaturOven extends CI_Controller
{
    ...
    public function index($id_oven = null)
    {
        ...
        if ($SqlValidate->num_rows() > 0) {
            return redirect("TemperaturOven/form_detail_temperature/$id_oven");
        }

        $this->data['page_title'] = "Temperature Oven";
        $this->data['page_content'] = "TempOven/index";
        $this->data['script_page'] =  '<script src="' . base_url() . 'assets/TempOven/index.js"></script>';
    ...
    public function form_detail_temperature($id_oven)
    {
        ...
        $this->data['script_page'] =  '<script src="' . base_url() . 'assets/TempOven/form_detail_temp.js"></script>';
    ...
    public function Monitoring_history_temp_oven()
    {
        ...
        $this->data['script_page'] =  '<script src="' . base_url() . 'assets/TempOven/monitoring_temp_oven.js"></script>';
    ...
    {
        $DocNo = $this->help->Gnrt_Identity_Number_DocOven('FOR', $this->input->post('oven'));
        $dataArray = [
            "Doc_No" => $DocNo,
            "Doc_Status" => "RUN",
    ...
    public function DataTable_Monitoring_Hdr_Temp()
    {
        ...
        JOIN tmst_karyawan tk_pj_oven on hdr.Pj_Oven = tk_pj_oven.initial
        JOIN tmst_karyawan tk_maintenance on hdr.Maintenance = tk_maintenance.initial
        JOIN tmst_karyawan tk_m_teknik on hdr.M_Teknik = tk_m_teknik.initial
        JOIN tmst_identity_oven on hdr.SysId_Oven = tmst_identity_oven.sysid 
