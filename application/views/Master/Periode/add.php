                ...
                <form method="post" enctype="multipart/form-data" action="#" id="main-form">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?= base_url('MasterData/Periode/') ?>" class="btn btn-danger btn-sm" title="back" data-toggle="tooltip">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Tahun :</label>
                                <input type="text" class="form-control form-control-sm" name="tahun" id="tahun" placeholder="Tahun" required>
                            </div>
                        </div>
                    </div>
