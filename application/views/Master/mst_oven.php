            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <button type="button" class="btn bg-gradient-primary btn-xs" data-toggle="modal" data-target="#modal-add-oven">
                        <span class="btn-label"><i class="fas fa-plus"></i></span> | Master Oven
                    </button>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="tbl-master" class="table table-sm table-bordered table-striped display nowrap" style="width: 100%;">
                            ...
                            <tbody>
                                <?php $i = 1;
                                foreach ($ovens->result() as $li) : ?>
                                    <tr id="<?= $li->sysid ?>">
                                        <td class="text-center"><?= $i; ?></td>
                                        <td class="text-center"><?= $li->nama ?></td>
                                        <td class="text-center"><?= $li->description ?></td>
        ...
        <div class="modal fade" id="modal-add-oven" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="form-edit" method="POST" action="<?= base_url('Master/store_oven') ?>">
                        <div class="modal-header">
                            <h5 class="modal-title">Add Master Data Oven</h5>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" style="width: 130px;">Oven :</span>
                                        </div>
                                        <input type="text" class="form-control" required placeholder="Nama oven..." name="nama" id="nama">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" required placeholder="Deskripsi/Keterangan oven..." name="deskripsi" id="deskripsi">
                                    </div>
                                </div>
                            </div>
                        </div>
