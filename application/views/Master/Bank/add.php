                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                                ...
                                <select class="form-control form-control-sm select2" name="id_bank" id="id_bank" required>
                                    <?php foreach ($bank->result() as $row) : ?>
                                        <option value="<?= $row->SysId ?>"><?= $row->kode_bank ?> - <?= $row->nama_bank ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
							<div class="col-lg-6 col-sm-12 px-4 form-group">
                                ...
                                <select class="form-control form-control-sm select2" name="currency_bank" id="currency_bank" required>
                                    <?php foreach ($currency->result() as $row) : ?>
                                        <option value="<?= $row->Currency_ID ?>" <?= ($row->Is_Default == 1 ? 'selected' : '') ?>><?= $row->Currency_ID ?> - <?= $row->Currency_Description ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
						<div class="row">
                            <div class="col-lg-12 col-sm-12 px-4 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="kode_bank" id="kode_bank" placeholder="Kode Bank" required>
                            </div>
                        </div>
						<div class="row">
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Nomor Rekening Bank :</label>
                                <input type="text" class="form-control form-control-sm" name="nomor_rekening_bank" id="nomor_rekening_bank" placeholder="Nomor Rekening Bank" required>
                            </div>
							<div class="col-lg-6 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Nama Rekening Bank :</label>
                                <input type="text" class="form-control form-control-sm" name="nama_rekening_bank" id="nama_rekening_bank" placeholder="Nama Rekening Bank" required>
                            </div>
                        </div>
						<div class="row">
                            <div class="col-lg-12 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Cabang :</label>
                                <input type="text" class="form-control form-control-sm" name="cabang_bank" id="cabang_bank" placeholder="Cabang" required>
                            </div>
                        </div>
						<div class="row">
                            <div class="col-lg-12 col-sm-12 px-4 form-group">
						...
						<div class="row">
                            <div class="col-lg-12 col-sm-12 px-4 form-group">
                                ...
                                <textarea type="text" class="form-control form-control-sm" name="catatan" id="catatan" placeholder="Keterangan"></textarea>
                            </div>
                        </div>
                    </div>
