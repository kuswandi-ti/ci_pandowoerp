                    ...
                    <div class="card-body">
						...
						<div class="row">
							<div class="col-lg-6 col-sm-12 px-4 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="kode_cost_center" id="kode_cost_center" value="<?= $RowData->kode_cost_center ?>" placeholder="Kode Cost Center ...." required>
                            </div>
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Nama Cost Center :</label>
                                <input type="text" class="form-control form-control-sm" name="nama_cost_center" id="nama_cost_center" value="<?= $RowData->nama_cost_center ?>" placeholder="Nama Cost Center ...." required>
                            </div>
                        </div>
						<div class="row mt-3">
							<div class="col-lg-12 col-sm-12 px-4 form-group">
								...
								<select class="form-control form-control-sm select2" name="cc_group_id" id="cc_group_id" required>
									<?php foreach ($cc_group as $row) : ?>
										<option <?= ($RowData->cc_group_id == $row->sysid ? 'selected' : null) ?> value="<?= $row->sysid ?>"><?= $row->cc_group_code ?> (<?= $row->cc_group_name ?>)</option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
