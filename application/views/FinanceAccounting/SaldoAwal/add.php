                    ...
                    <div class="card-body">
						...
						<div class="row">
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="debit" id="debit" placeholder="Saldo Debet" required>
                            </div>
							<div class="col-lg-6 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Kredit :</label>
                                <input type="text" class="form-control form-control-sm" name="credit" id="credit" placeholder="Saldo Kredit" required>
                            </div>
                        </div>					
                    </div>
