					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-lg-12 col-sm-12 px-4 form-group">
								<label style="font-weight: 500;">Supplier</label>
								<select class="form-control form-control-sm select2" name="id_supplier" id="id_supplier" required>
									<?php foreach ($supplier->result() as $row) : ?>
										<option value="<?= $row->id_supplier ?>"><?= $row->code_supplier ?> - <?= $row->name_supplier ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							<div class="col-lg-12 col-sm-12 px-4 form-group">
									...
									<table id="table_item" class="table table-striped">
										<thead>
											<tr>
												...
												<th width="30%">Outstanding Payment</th>
												<th width="30%">Amount Payment</th>
												<th width="10%" class="text-center">Tipe Dokumen</th>
						...
						<div class="row">
							<div class="col-lg-12 col-sm-12 px-4 form-group text-right">
								<label style="font-weight: 500;">Total Payment</label>
