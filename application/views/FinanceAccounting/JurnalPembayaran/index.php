                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">No. Dokumen Ref.</label>
                                <select class="form-control form-control-sm select2" name="reff_id" id="reff_id" required>
                                    <?php
                            ...
                            <!-- <div class="col-lg-4 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">No. Payment Purchase</label>
                                <select class="form-control form-control-sm select2" name="reff_id" id="reff_id" required>
									<option value="">Pilih Nomor</option>
                                    <?php foreach ($payment_purchase->result() as $row) : ?>
                                        <option value="<?= $row->SysId ?>" data-doc_number="<?= $row->doc_number ?>" data-total="<?= $row->total ?>"><?= $row->doc_number ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div> -->
                            <div class="col-lg-2 col-sm-12 px-4 form-group">
                            ...
                            <div class="col-lg-2 col-sm-12 px-4 form-group">
                                <label style="font-weight: 500;">Type Doc.</label>
                                <input type="text" class="form-control form-control-sm" name="type_doc" id="type_doc" readonly>
                            </div>
...
<div class="modal fade" id="modal_list_item_coa" style="z-index: 1050 !important;" aria-labelledby="Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">List Akun</h5>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <!-- <label style="font-weight: 500;">Akun Induk</label>
					<select class="form-control form-control-sm select2" name="filter_akun_induk_coa" id="filter_akun_induk_coa">
						<?php foreach ($akun_induk->result() as $row) : ?>
							<option value="<?= $row->SysId ?>">
								<?= $row->kode_akun ?> - <?= $row->nama_akun ?>
							</option>
					...
					<br> -->
                    <div class="table-responsive">
                        <table id="DataTable_Modal_ListItem_Coa" class="table table-sm table-bordered table-striped display nowrap" style="width: 100%;">
                            <thead style="background-color: #3B6D8C;">
                                <tr class="text-center text-white">
                                    <th>#</th>
                                    <th>Akun Induk</th>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="select_item_coa"><i class="fas fa-check"></i> &nbsp;&nbsp;&nbsp;Select</button>
            </div>
        </div>
    </div>
</div>