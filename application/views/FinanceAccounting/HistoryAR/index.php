                        ...
                        <table id="DataTable" class="table-mini" style="width: 100%;">
                            <thead>
                                <tr>
									...
									<th class="text-center text-dark">NO. INVOICE CUSTOMER</th>
									<th class="text-center text-dark">AMOUNT INVOICE</th>
									<th class="text-center text-dark">NO. RECEIVE</th>
									<th class="text-center text-dark">AMOUNT RECEIVE</th>
                                </tr>
                            </thead>
                            <tbody>
