                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-sm-12 px-4 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" value="<?= $RowData->trx_name ?>" name="trx_name" id="trx_name" placeholder="Nama Transaksi" required>
                            </div>
                        </div>
						<div class="row">
                            <div class="col-lg-6 col-sm-6 px-4 form-group">
                                ...
                                <select class="form-control form-control-sm select2" name="id_akun_debit" id="id_akun_debit" required>
									<?php foreach ($akun->result() as $row) : ?>
                                        <option <?= ($RowData->id_akun_debit == $row->SysId ? 'selected' : null) ?> value="<?= $row->SysId ?>"><?= $row->kode_akun ?> - <?= $row->nama_akun ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
							<div class="col-lg-6 col-sm-6 px-4 form-group">
                                ...
                                <select class="form-control form-control-sm select2" name="id_akun_credit" id="id_akun_credit" required>
									<?php foreach ($akun->result() as $row) : ?>
                                        <option <?= ($RowData->id_akun_credit == $row->SysId ? 'selected' : null) ?> value="<?= $row->SysId ?>"><?= $row->kode_akun ?> - <?= $row->nama_akun ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
