    ...
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-header">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="tampilan-by-dekripsi-tab" data-toggle="pill" href="#tampilan-by-deskripsi" role="tab" aria-controls="tampilan-by-deskripsi" aria-selected="true"><i class="fas fa-eye"></i> DETAIL DATA</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tampilan-by-lot-tab" data-toggle="pill" href="#tampilan-by-lot" role="tab" aria-controls="tampilan-by-lot" aria-selected="false"><i class="fas fa-eye"></i> SUMMARY ITEM</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="basic-url">Tanggal Alokasi :</label>
                            ...
                            <table id="DataTable_Detail" class="table table-sm table-striped table-bordered display compact nowrap" style="width: 100%;">
                                <thead style="background-color: #3B6D8C;">
                                    <tr>
                                        ...
                                        <th class="text-center text-white">Doc. No</th>
                                        <th class="text-center text-white">Tgl. Alokasi</th>
                                        ...
                                        <th class="text-center text-white">Nilai Item</th>
                                        <th class="text-center text-white">Total Nilai</th>
                                        <th class="text-center text-white">Warehouse</th>
                                        <th class="text-center text-white">Item Category</th>
