        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card card-primary card-outline">
                            ...
                            <div class="input-group input-group-sm">
                                <select type="text" class="form-control" id="oven" name="oven">
                                    ...
                                    <?php foreach ($ovens as $li) : ?>
                                        <option value="<?= $li->Warehouse_ID ?>"><?= $li->Warehouse_Code ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <div class="input-group-prepend">
                                    <button type="button" data-toggle="tooltip" title="Melihat Detail Bundle" id="preview--lot" class="btn bg-gradient-danger"> &nbsp;&nbsp;&nbsp;<b><i class="fas fa-barcode"></i></b>&nbsp;&nbsp;&nbsp; </button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4"></div>
                ...
                <div class="card-footer text-center">
                    <button type="button" data-toggle="tooltip" title="Menyatakan bundle masuk oven" class="btn btn-primary btn-lg float-center" id="submit--lotNo"><i class="fas fa-download"></i> &nbsp;&nbsp;KONFIRMASI MASUK KD</button>
                </div>
            </div>
        </div>
                        ...
                        <table id="Detail-Data-Lot" class="table-sm table-striped table-bordered" style="width: 100%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center" id="GUDANG"></td>
