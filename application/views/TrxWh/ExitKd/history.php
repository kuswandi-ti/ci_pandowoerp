    ...
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-header">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="tampilan-by-lot-tab" data-toggle="pill" href="#tampilan-by-lot" role="tab" aria-controls="tampilan-by-lot" aria-selected="false"><i class="fas fa-eye"></i> REKAP BY BUNDLE</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tampilan-by-dekripsi-tab" data-toggle="pill" href="#tampilan-by-deskripsi" role="tab" aria-controls="tampilan-by-deskripsi" aria-selected="true"><i class="fas fa-eye"></i> REKAP BY JENIS ITEM</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" name="from" id="from" required class="form-control text-center flatpickr-input readonly" value="<?= date('Y-m-01') ?>">
                                <div class="input-group-prepend">
                                    <button type="button" class="btn btn-info"><i class="fas fa-calendar"></i> S/D</button>
                                </div>
                                <input type="text" name="to" id="to" required class="form-control text-center flatpickr-input readonly" value="<?= date('Y-m-t') ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1">
                            ...
                            <table id="DataTable_Lot" class="table-mini dt-nowrap" style="width: 100%;">
                                <thead style="background-color: #3B6D8C;">
                                    <tr>
                                        ...
                                        <th class="text-center text-white">BUNLE</th>
                                        ...
                                        <th class="text-center text-white"><i class="fas fa-clock"></i> TMER KILN</th>
