                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="Doc_No" id="Doc_No" placeholder="Doc Number Akan Otomatis : PRD-<?= date('ym') ?>-XXXX" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                            ...
                            <div class="col-lg-6 col-sm-12 px-4 form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    <textarea name="Note" id="Note" class="form-control" required placeholder="catatan...."></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
