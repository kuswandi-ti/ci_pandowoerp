        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    <form id="form_lpb" method="post" action="<?= base_url('TrxWh/Lpb/store_lpb') ?>">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <div class="row" id="el-srno" style="display: none;">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>No. Sales Return :</label>
                                        <input type="text" class="form-control form-control-sm" name="SR_Numb" id="SR_Numb" placeholder="No Sales Return..." maxlength="25">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="form-control form-control-sm flatpickr-input" required name="tgl_kirim" id="tgl_kirim" placeholder="Tanggal kirim..." value="<?= date('Y-m-d') ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-sm" name="Note" id="Note" placeholder="Informasi tambahan" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" required name="Currency" id="Currency">
                                            <?php foreach ($List_Currency->result() as $curr) : ?>
                                                <option <?= ($curr->Is_Default == 1 ? 'selected' : null) ?> value="<?= $curr->Currency_ID ?>"><?= $curr->Currency_ID ?> (<?= $curr->Currency_Description ?>)</option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
