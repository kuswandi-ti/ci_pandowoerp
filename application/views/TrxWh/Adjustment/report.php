    ...
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-header">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" id="tampilan-by-lot-tab" data-toggle="pill" href="#tampilan-by-lot" role="tab" aria-controls="tampilan-by-lot" aria-selected="false"><i class="fas fa-eye"></i> Detail Penyesuaian Stok Barang</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="basic-url">Tanggal Penyesuaian :</label>
                            ...
                            <table id="DataTable_Detail" class="table table-sm table-striped table-bordered display compact nowrap" style="width: 100%;">
                                <thead style="background-color: #3B6D8C;">
                                    <tr>
                                        ...
                                        <th class="text-center text-white">Tgl. Penyesuaian</th>
                                        ...
                                        <th class="text-center text-white">Jenis Penyesuaian</th>
                                        <th class="text-center text-white">Unit Price (IDR)</th>
                                        <th class="text-center text-white">Nilai Penyesuaian</th>
