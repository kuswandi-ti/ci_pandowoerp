                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="input-group input-group-sm">
                                    <input type="text" name="from" id="from" required class="form-control flatpickr-input readonly" value="<?= date('Y-m-01') ?>">
                                    <div class="input-group-prepend">
                                        <button type="button" class="btn btn-info"><i class="fas fa-calendar"></i> S/D</button>
                                    </div>
                                    <input type="text" name="to" id="to" required class="form-control flatpickr-input readonly" value="<?= date('Y-m-t') ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                        ...
                        <table id="DataTable" class="table-mini" style="width: 100%;">
                            <thead style="background-color: #3B6D8C;">
                                <tr>
                                    ...
                                    <th class="text-center text-white">PENILAIAN</th>
