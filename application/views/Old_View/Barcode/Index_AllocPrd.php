        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card card-primary card-outline">
                ...
                <div class="card-footer text-center">
                    <button type="button" data-toggle="tooltip" title="nyatakan alokasi ke produksi" class="btn btn-success btn-lg float-center" id="submit--lotNo"><i class="fas fa-external-link-alt"></i> | Alokasikan Ke Produksi</button>
                </div>
            </div>
        </div>
                        ...
                        <table id="Detail-Data-Lot" class="table-sm table-striped table-bordered" style="width: 100%;">
                            <thead style="background-color: #3B6D8C;">
                                <tr>
                                    ...
                                    <th class="text-center text-white">TIMER OVEN</th>
