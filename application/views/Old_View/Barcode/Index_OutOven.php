        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card card-primary card-outline">
                            ...
                            <div class="input-group input-group-sm">
                                <select type="text" class="form-control" id="placement" name="placement">
                                    ...
                                    <?php foreach ($placements as $li) : ?>
                                        <option value="<?= $li->sysid ?>"><?= $li->lokasi ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="card-footer text-center">
                    <button type="button" data-toggle="tooltip" title="Menyatakan lot keluar oven" class="btn btn-success btn-lg float-center" id="submit--lotNo"><i class="fas fa-external-link-alt"></i> | NYATAKAN SEBAGAI KELUAR OVEN</button>
                </div>
            </div>
        </div>
