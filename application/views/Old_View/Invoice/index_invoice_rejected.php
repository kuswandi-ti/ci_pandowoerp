        ...
        <div class="col-lg-12 col-sm-12">
            <div class="card card-danger">
                <div class="card-header">
                    <h3 class="card-title">Database Invoice Rejected</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="TableData" class="table-sm table-striped table-bordered display compact nowrap table-valign-middle" style="width: 100%;">
