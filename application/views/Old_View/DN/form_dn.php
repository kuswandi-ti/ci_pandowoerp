<div class="container-fluid">
    <div class="row">
        <div class="col-lg-6 col-sm-6">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title"><b>Form Delivery Note</b></h3>
        ...
        <!----------------------------------------------- END HEADER ------------------------------------->
        <div class="col-lg-6 col-sm-6" id="location-detail-form" style="display: none;">
            <div class="card card-primary card-outline">
                <div class="card-header">
...
<div id="location-modal-customer">

</div>
<div id="location-modal-po">

</div>
<div id="location-modal-vehicle">

</div>
<div id="location-modal-driver">
