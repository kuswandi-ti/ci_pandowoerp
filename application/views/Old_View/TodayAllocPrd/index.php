...
<div class="col-lg-12">
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-header">
            <h3 class="card-title pt-2">REKAP ALOKASI MATERIAL KE PRODUKSI</h3>
            <ul class="nav nav-tabs float-right" id="custom-tabs-four-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="tampilan-by-dekripsi-tab" data-toggle="pill" href="#tampilan-by-deskripsi" role="tab" aria-controls="tampilan-by-deskripsi" aria-selected="true"><i class="fas fa-eye"></i> BY DESKRIPSI UKURAN</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="tampilan-by-lot-tab" data-toggle="pill" href="#tampilan-by-lot" role="tab" aria-controls="tampilan-by-lot" aria-selected="false"><i class="fas fa-eye"></i> BY NOMOR LOT</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                            ...
                            <table id="DataTable_Lot" class="table table-sm table-striped table-bordered display compact nowrap" style="width: 100%;">
                                <thead style="background-color: #3B6D8C;">
                                    <tr>
                                        ...
                                        <th class="text-center text-white"><i class="far fa-calendar"></i> Waktu Oven</th>
                                        <th class="text-center text-white"><i class="fas fa-clock"></i> Timer Oven</th>
                                        <th class="text-center text-white"><i class="fas fa-calendar"></i> Alloc-Prd</th>
                                        <th class="text-center text-white"><i class="fas fa-pallet"></i> Product</th>
                                    </tr>
                                </thead>
                                <tbody style="color: black;">
                                    <!-- hi dude i dude some magic here -->
