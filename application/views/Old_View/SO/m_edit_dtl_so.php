...
<div class="modal fade" id="m_edit_dtl_so" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="max-width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><b>Update Detail Item PO : <?= $Hdr->No_Po_Customer ?> (<?= $Hdr->Doc_No_Internal ?>)</b></h5>
                    ...
                    <div class="row">
                        <div class="card-body">
                            <form id="form-detail-po" action="#">
                                ...
                                <input type="hidden" id="customer" name="customer" value="<?= $Hdr->ID_Customer ?>">
                                                ...
                                                <tr data-pk="<?= $li->SysId ?>" id="row_<?= $li->SysId ?>">
                                                    ...
                                                    <td>
                                                        <select class="form-control form-control-xs" style="width: 100%;" name="Product[]" data-pk="<?= $li->SysId ?>">
                                                            <option selected value="<?= $li->Product_ID ?>"><?= $li->Product_Name ?> <?php if (!empty($li->Product_Code)) echo '(' ?><?= $li->Product_Code ?><?php if (!empty($li->Product_Code)) echo ')' ?></option>
                                                        </select>
                                                    </td>
                                                    <td>
                                ...
                                <div class="card-footer mt-4">
                                    <div class="col-lg-12 col-sm-12">
                                        <button type="button" class="btn btn-primary float-right" id="submit-form"><i class="fas fa-save"></i> | Save Change</button>
...
<script src="<?= base_url() ?>assets/PO/form_detail_po_edit.js"></script>