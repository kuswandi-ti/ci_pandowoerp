                        ...
                        <table id="DataTable" class="table table-sm table-bordered" style="width: 100%;">
                            <thead style="background-color: #3B6D8C;">
                                <tr class="text-white">
                                    ...
                                    <th class="text-center vertical-align-middle">Nomor Invoice</th>
                                    <th class="text-center vertical-align-middle">Tanggal Invoice</th>
                                    <th class="text-center vertical-align-middle">Tanggal Jatuh Tempo</th>
                                    <th class="text-center vertical-align-middle">Nama Customer</th>
                                    <th class="text-center vertical-align-middle">Status Pembayaran</th>
                                </tr>
                            </thead>
                            <tbody>
