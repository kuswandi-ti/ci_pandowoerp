...
<body>
    <div id="container">
		...
		<div class="text-center">
            <h4 class="header-container">JURNAL PENERIMAAN</h4>
            <br>
        </div>
		...
		<table width="100%" class="tbl-header">
			<tr>
                ...
                <td width="1%">:</td>
                <td width="84%"><?php echo $data_hdr->Account_Name; ?></td>
            </tr>
			<tr>
                <td width="15%">Keterangan</td>
                <td width="1%">:</td>
                <td width="84%"><?php echo $data_hdr->keterangan; ?></td>
            </tr>
			<tr>
                <td width="15%">Referensi</td>
                <td width="1%">:</td>
                <td width="84%"><?php echo $data_hdr->reff_desc; ?></td>
            </tr>
		</table>
