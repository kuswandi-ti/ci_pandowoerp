$(document).ready(function () {
	...
	function DataTable_Detail() {
		var DataTable_Detail = $("#DataTable_Detail").DataTable({
			...
			ajax: {
				url: $('meta[name="base_url"]').attr('content') + "TrxWh/UsageNote/DT_report_un_detail",
				dataType: "json",
				type: "POST",
				data: {
					"from": $('#from').val(),
			...
			columns: [{
				...
				{
					data: "Base_TotalPrice",
					name: "Base_TotalPrice",
					render: function (data) {
						return formatIdr(data)
					}
				},
	...
	function DataTable_Summarize() {
		var DataTable_Lot = $("#DataTable_Lot").DataTable({
			...
			ajax: {
				url: $('meta[name="base_url"]').attr('content') + "TrxWh/UsageNote/DT_report_un_sum",
				dataType: "json",
				type: "POST",
				data: {
					"from": $('#from').val(),
