$(document).ready(function () {
	...
	function Initialize_Datatable() {
		$("#DataTable").DataTable({
			...
			paging: false,
			ajax: {
				url: $('meta[name="base_url"]').attr('content') + "FinanceAccounting/HistoryAP/DT_List_History_AP",
				dataType: "json",
				type: "GET",
				data: {
			...
			columns: [{
					...
					data: "no_doc_supplier",
					name: "no_doc_supplier",
				}, {
					data: "type_doc",
					name: "type_doc",
				}, {
			...
			"buttons": ["copy",
				{
					extend: 'csvHtml5',
					title: $('title').text() + '~' + ' - ' + $('select[name=id_supplier] option:selected').text(),
